            ...
            <div class="col-lg-10 col-md-10">
                <div class="card mt-3">
                    ...
                    <div class="card-body" style="background:blanchedalmond">
                        <form action="{{url('add/free/job')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-5 text-center">
                                    ...
                                    <div class="text-dark pt-3">
                                        <b style="font-weight: 600; font-size: 24px;">Total Cost :</b> <input type="text" name="total_cost" id="total_cost" style="border-style:none;background:transparent;color:darkblue;font-weight: 700;font-size: 25px;width: 60px" value="0" readonly> <b style="font-weight: 600; font-size: 24px;"><i class="fas fa-euro-sign"></i></b>
                                    </div>
                                </div>
                                <div class="col-lg-7 pt-4 text-center">
                                    <input type="submit" value="Pay Now & Post My Job" class="btn btn-success rounded mr-3">
